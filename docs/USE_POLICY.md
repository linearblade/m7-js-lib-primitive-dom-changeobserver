# 📘 m7-js-lib-primitive-dom-changeobserver Use Policy

This document outlines how you may use m7-js-lib-primitive-dom-changeobserver under the **Moderate Team License (MTL-10)** and what is expected of you as a user.

---

## ✅ Free Use — What You Can Do

You may use m7-js-lib-primitive-dom-changeobserver **for free** if you fall under any of the following categories:
...
* **Startups or companies** with **10 or fewer users** of m7-js-lib-primitive-dom-changeobserver internally
...
m7-js-lib-primitive-dom-changeobserver **may not be used** in the following ways without a paid commercial license:
...
* Internally at companies with **more than 10 users** working with m7-js-lib-primitive-dom-changeobserver
...
* **User**: Anyone who installs, configures, modifies, integrates, or interacts with m7-js-lib-primitive-dom-changeobserver as part of their role.
