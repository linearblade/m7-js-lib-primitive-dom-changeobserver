...
export default class DomChangeObserver {
	...
	this._MO = this._MO || this._getMO();
	if (!this._MO) {
            throw new Error("DomChangeObserver.start(): MutationObserver is not available in this environment.");
	}
 ...
 *   Initial selector(s) to register.
 *
 * @property {boolean} [includeSubtreeMatches=true]
